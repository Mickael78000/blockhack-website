...
export const ServiceCard = (props: ServiceCardProps) => {
  return (
    <div
      className={`text-[15.1297px] box-border caret-transparent flex leading-[24.2075px] mt-[37.8243px] md:text-[15.667px] md:leading-[25.0672px] md:mt-0 ${props.variant || ""}`}
    >
      <div className="relative text-[15.1297px] shadow-[rgba(255,255,255,0.17)_1px_1px_3px_0px_inset,rgba(0,0,0,0.67)_5px_5px_28px_4px] box-border caret-transparent saturate-100 leading-[24.2075px] md:text-[15.667px] md:leading-[25.0672px]">
        ...
        <div className="relative text-[15.1297px] bg-stone-950 box-border caret-transparent h-full leading-[24.2075px] text-left z-[2] border border-zinc-800 px-[22.6946px] py-[18.9121px] rounded-bl rounded-br rounded-tl rounded-tr border-solid md:text-[15.667px] md:leading-[25.0672px] md:pt-[54.8346px] md:pb-[39.1675px] md:px-[31.334px]">
