...
export const TeamSection = () => {
  return (
    <div className="text-[15.1297px] bg-no-repeat bg-size-[15%] box-border caret-transparent leading-[24.2075px] bg-[position:34%_91%] pt-[50px] pb-20 md:text-[15.667px] md:leading-[25.0672px]">
      <div className="relative text-[15.1297px] box-border caret-transparent leading-[24.2075px] max-w-[1248.2px] text-left w-full z-[5] ml-0 mr-auto mt-10 pt-[60px] pb-5 px-[25px] md:text-[15.667px] md:leading-[25.0672px] md:max-w-[1292.53px] md:ml-auto">
        ...
        <p className="text-[24.6946px] font-normal box-border caret-transparent leading-[30.3682px] max-w-[870px] w-full mb-2.5 text-justify md:text-[25.5005px] md:leading-[31.3757px] md:max-w-[900px]">
          Avec des années d'expérience à notre actif, nous sommes prêts pour tous les
          défis.
        </p>
        <div className="text-[15.1297px] content-start items-start box-border caret-transparent gap-x-[15.1297px] flex flex-col auto-cols-[1fr] [grid-template-areas:'._._Area'] grid-cols-[1fr] grid-rows-[auto] justify-items-start leading-[24.2075px] gap-y-[30.2594px] mt-[15.1297px] md:text-[15.667px] md:gap-x-[31.334px] md:grid md:flex-row md:grid-cols-[1fr_1fr_1fr] md:leading-[25.0672px] md:gap-y-[31.334px] md:mt-[58.7513px]">
